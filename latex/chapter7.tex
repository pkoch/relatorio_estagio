...
O primeiro aspecto a ter em mente é o sítio que cada Beacon terá. Estes devem estar dispostos de modo a que todas as posições a monitorizar estejam cobertas pelo alcance de, pelo menos, três Beacons. Assumindo que queremos monitorar a presença de Rovers numa sala inteira, na figura~\ref{fig:BadSetup} temos um exemplo de um mau posicionamento, na figura~\ref{fig:GoodSetup} o de um bom posicionamento.


\begin{figure}[t]
  \centering
  \includegraphics[width=106mm]{GoodSetup.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=106mm]{BadSetup.png}
...
\begin{figure}[t]
  ...
  \caption{Exemplo de funcionamento do \cname{Visualizer} em funcionamento.}
  \label{fig:Demo}
\end{figure}
