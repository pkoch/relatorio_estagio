...
\hypersetup{pdftitle={\projecto},pdfsubject={Relatório do Estágio Curricular da LEIC \ano},pdfkeywords={},pdfauthor={Paulo Jorge Duarte Köch},pdfcreator={wordml2latex }, colorlinks=true, linkcolor=red, anchorcolor=black, citecolor=green, filecolor=magenta, menucolor=red, pagecolor=red, urlcolor=blue, breaklinks=true, pdfstartview=FitH, pdfpagemode=UseOutlines}
...
\fancyhead[LO]{LEIC/\ano/Relatório de Estágio} % one sided
