...
Antes de sequer testar as medidas como foi feito no capítulo \ref{ch:investigacao}, foi preciso criar um ambiente que permitisse acesso ao HCI.
...
\begin{enumerate}
\item Passar por todos os objectos \cname{Ruler} e recolher a distância que cada um representa e a medição ai guardada,
